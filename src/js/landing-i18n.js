...
(function () {
  ...
  const DICT = {
    ...
    'about.p3':        { fr: '2 mois de dev en solo, 8 bêta testeurs qui ont fait des retours brutaux, zéro pub, zéro investisseur. Projet <strong>indépendant et hébergé en Europe</strong>. Quand tu écris au support, c\'est une vraie personne qui te répond, pas un bot.', en: '2 months of solo dev, 8 beta testers who gave brutal feedback, no ads, no investors. <strong>Independent project, hosted in Europe</strong>. When you contact support, a real person replies, not a bot.' },
