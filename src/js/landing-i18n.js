...
(function () {
  ...
  const DICT = {
    ...
    'pr.funded.tagline': { fr: 'Pour le trader qui pilote 2-10 funded accounts.', en: 'For the trader running 2-10 funded accounts.' },
    ...
    'pr.funded.f1':      { fr: '10 comptes (prop / crypto / personnel)', en: '10 accounts (prop / crypto / personal)' },
    'pr.funded.f2':      { fr: 'IA détecte entry/SL/TP depuis ton screenshot TradingView (20×/jour)', en: 'AI detects entry/SL/TP from your TradingView screenshot (20×/day)' },
    'pr.funded.f3':      { fr: '1 trade saisi → répliqué sur tes 10 comptes en 1 sauvegarde', en: '1 trade entered → replicated across your 10 accounts in 1 save' },
    ...
    'pr.elite.f1':       { fr: '100 comptes — multi-funded ou portefeuille coach', en: '100 accounts — multi-funded or coach portfolio' },
    'pr.elite.f2':       { fr: '5× plus d\'IA (100/jour) — valide chaque trade', en: '5× more AI (100/day) — validate every trade' },
    ...
    'faq.a1':          { fr: 'Le plan <strong>Trader</strong> est gratuit pour toujours (1 compte, 1 analyse IA/jour). Le plan <strong>Funded</strong> à 14,99 €/mois débloque 10 comptes, 20 analyses IA/jour, groupes multi-comptes, export PDF, calcul EOD précis. Le plan <strong>Elite</strong> à 29,99 €/mois passe à 100 comptes, 100 IA/jour, accès anticipé aux features beta. Les 5 dernières places Founding offrent un accès Funded à vie en échange de feedback.', en: 'The <strong>Trader</strong> plan is free forever (1 account, 1 AI analysis/day). The <strong>Funded</strong> plan at €14.99/mo unlocks 10 accounts, 20 AI analyses/day, multi-account groups, PDF export and accurate EOD calculation. The <strong>Elite</strong> plan at €29.99/mo goes up to 100 accounts, 100 AI/day and early access to beta features. The last 5 Founding spots grant lifetime Funded access in exchange for feedback.' },
    ...
    'faq.a4':          { fr: '1 compte sur le plan Trader, 10 comptes sur Funded, jusqu\'à 100 comptes sur Elite. Les plans Funded et Elite débloquent les <strong>groupes multi-comptes</strong> : 1 trade saisi peut être répliqué sur plusieurs comptes en une seule sauvegarde.', en: '1 account on the Trader plan, 10 accounts on Funded, up to 100 accounts on Elite. The Funded and Elite plans unlock <strong>multi-account groups</strong>: one entered trade can be replicated across several accounts in a single save.' },
