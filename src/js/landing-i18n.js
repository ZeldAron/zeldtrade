...
(function () {
  ...
  const DICT = {
    ...
    'hero.cta.nocard': { fr: 'Annulation en 1 clic', en: 'Cancel anytime' },
    ...
    'pricing.sub':   { fr: 'Essai 14 jours. Annulation en 1 clic. Si tu pars, tu emportes tes données.', en: '14-day trial. Cancel anytime. If you leave, you take your data.' },
    'midcta.label': { fr: 'Le tracking qui t\'empêche de cramer le suivant.', en: 'The tracking that stops you blowing the next one.' },
    'midcta.cta':   { fr: "Commencer l'essai 14 jours →", en: 'Start your 14-day trial →' },
    'pricing.badge':    { fr: '✦ Recommandé', en: '✦ Recommended' },
    'pricing.reassure': { fr: 'Essai 14 j · annulation en 1 clic · sans engagement', en: '14-day trial · cancel anytime · no commitment' },
    ...
    'reviews.eyebrow': { fr: '// AVIS', en: '// REVIEWS' },
    'pricing.eyebrow': { fr: '// TARIFS', en: '// PRICING' },
    'reviews.title':   { fr: 'Ce que disent les premiers traders.', en: 'What early traders say.' },
    'reviews.sub':     { fr: 'Avis vérifiés, publiés sur Trustpilot.', en: 'Verified reviews, published on Trustpilot.' },
    'reviews.r1.role': { fr: 'Trader · via Trustpilot', en: 'Trader · via Trustpilot' },
    'reviews.r1.text': { fr: "« Après plus d'un an de trading, c'est sans hésitation la meilleure plateforme que j'ai utilisée pour tenir un journal de trading. L'interface est claire, soignée, rapide et extrêmement efficace. Elle en vaut VRAIMENT le coup ! »", en: '"After over a year of trading, this is hands down the best platform I have used to keep a trading journal. The interface is clean, polished, fast and extremely effective. Truly worth it!"' },
    'reviews.cta.title': { fr: 'Toi aussi, laisse ton avis', en: 'Leave your review too' },
    'reviews.cta.sub':   { fr: '30 secondes sur Trustpilot →', en: '30 seconds on Trustpilot →' },
    ...
    'pricing.lifetime.desc':    { fr: 'Tu paies une fois. À toi pour toujours.', en: 'Pay once. Yours forever.' },
    'pricing.lifetime.f1':      { fr: 'Tout Elite, à vie', en: 'Everything in Elite, forever' },
    'pricing.lifetime.f2':      { fr: 'Comptes & groupes illimités', en: 'Unlimited accounts & groups' },
    'pricing.lifetime.f3':      { fr: 'IA illimitée · Claude Sonnet', en: 'Unlimited AI · Claude Sonnet' },
    'pricing.lifetime.f4':      { fr: 'Toutes les futures features', en: 'All future features' },
    'pricing.lifetime.f5':      { fr: 'Un paiement, zéro renouvellement', en: 'One payment, no renewal' },
